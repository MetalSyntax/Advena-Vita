/**
 * @brief Copyright (C) 2008 The Android Open Source Project All rights reserved.
 * @note See `docs/source/reimpl/bits/_errno_bionic.md:1` for detailed design rationale.
 */
...
/**
 * @brief On Linux, ENOTSUP and EOPNOTSUPP are the same despite POSIX saying they should be distinct.
 * @note See `docs/source/reimpl/bits/_errno_bionic.md:172` for detailed design rationale.
 */
